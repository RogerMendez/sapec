...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Cargo.sueldo_max'
        db.add_column(u'organizacion_cargo', 'sueldo_max',
                      self.gf('django.db.models.fields.FloatField')(default='1200'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Cargo.sueldo_max'
        db.delete_column(u'organizacion_cargo', 'sueldo_max')
    ...
    models = {
        ...
        u'organizacion.cargo': {
            ...
            'sueldo_max': ('django.db.models.fields.FloatField', [], {'default': "'1200'"}),
