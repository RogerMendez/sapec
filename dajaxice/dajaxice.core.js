...
var Dajaxice = {
    ...
    employee: function(callback_function, argv, custom_settings){
        return Dajaxice.call('personal.employee', 'POST', callback_function, argv, custom_settings);
    },

    multiply: function(callback_function, argv, custom_settings){
        return Dajaxice.call('personal.multiply', 'POST', callback_function, argv, custom_settings);
    }
